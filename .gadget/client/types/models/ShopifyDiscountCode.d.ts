...
import { Query, Select, DeepFilterNever, IDsList, ShopifyDiscountCode, ShopifyDiscountCodeSort, ShopifyDiscountCodeFilter, AvailableShopifyDiscountCodeSelection, CreateShopifyDiscountCodeInput, UpdateShopifyDiscountCodeInput } from "../types.js";
 ...
 **/
export type CreateShopifyDiscountCodeResult<Options extends CreateShopifyDiscountCodeOptions> = SelectedShopifyDiscountCodeOrDefault<Options> extends void ? void : GadgetRecord<SelectedShopifyDiscountCodeOrDefault<Options>>;
/**
  * Executes the create action. Accepts the parameters for the action via the `variables` argument. Runs the action and returns a Promise for the updated record.
  */
declare function createShopifyDiscountCode<Options extends CreateShopifyDiscountCodeOptions>(variables: CreateShopifyDiscountCodeVariables, options?: LimitToKnownKeys<Options, CreateShopifyDiscountCodeOptions>): Promise<CreateShopifyDiscountCodeResult<Options>>;
declare function createShopifyDiscountCode<Options extends CreateShopifyDiscountCodeOptions>(variables: FullyQualifiedCreateShopifyDiscountCodeVariables, options?: LimitToKnownKeys<Options, CreateShopifyDiscountCodeOptions>): Promise<CreateShopifyDiscountCodeResult<Options>>;
/**
 * The fully-qualified, expanded form of the inputs for executing this action.
 * The flattened style should be preferred over this style, but for models with ambiguous API identifiers, this style can be used to remove any ambiguity.
 **/
 ...
 * "Is a GadgetRecord of the model's type."
 **/
export type UpdateShopifyDiscountCodeResult<Options extends UpdateShopifyDiscountCodeOptions> = SelectedShopifyDiscountCodeOrDefault<Options> extends void ? void : GadgetRecord<SelectedShopifyDiscountCodeOrDefault<Options>>;
/**
  * Executes the update action on one record specified by `id`. Runs the action and returns a Promise for the updated record.
  */
declare function updateShopifyDiscountCode<Options extends UpdateShopifyDiscountCodeOptions>(id: string, variables: UpdateShopifyDiscountCodeVariables, options?: LimitToKnownKeys<Options, UpdateShopifyDiscountCodeOptions>): Promise<UpdateShopifyDiscountCodeResult<Options>>;
declare function updateShopifyDiscountCode<Options extends UpdateShopifyDiscountCodeOptions>(id: string, variables: FullyQualifiedUpdateShopifyDiscountCodeVariables, options?: LimitToKnownKeys<Options, UpdateShopifyDiscountCodeOptions>): Promise<UpdateShopifyDiscountCodeResult<Options>>;
/**
 * The return value from executing delete on shopifyDiscountCode.
 * "Is void because this action deletes the record"
 **/
export type DeleteShopifyDiscountCodeResult<Options extends DeleteShopifyDiscountCodeOptions> = void extends void ? void : GadgetRecord<SelectedShopifyDiscountCodeOrDefault<Options>>;
/**
  * Executes the delete action on one record specified by `id`. Deletes the record on the server. Returns a Promise that resolves if the delete succeeds.
  */
declare function deleteShopifyDiscountCode<Options extends DeleteShopifyDiscountCodeOptions>(id: string, options?: LimitToKnownKeys<Options, DeleteShopifyDiscountCodeOptions>): Promise<DeleteShopifyDiscountCodeResult<Options>>;
 ...
 **/
    ...
    create: typeof createShopifyDiscountCode & {
        type: "action";
        ...
        schemaType: Query["shopifyDiscountCode"];
        variablesType: ((FullyQualifiedCreateShopifyDiscountCodeVariables | CreateShopifyDiscountCodeVariables)) | undefined;
        variables: {
            "shopifyDiscountCode": {
                required: false;
...
*/
    bulkCreate: {
        <Options extends CreateShopifyDiscountCodeOptions>(inputs: (FullyQualifiedCreateShopifyDiscountCodeVariables | CreateShopifyDiscountCodeVariables)[], options?: LimitToKnownKeys<Options, CreateShopifyDiscountCodeOptions>): Promise<CreateShopifyDiscountCodeResult<Options>[]>;
        type: "action";
    ...
    update: typeof updateShopifyDiscountCode & {
        type: "action";
...
*/
    bulkUpdate: {
        <Options extends UpdateShopifyDiscountCodeOptions>(inputs: (FullyQualifiedUpdateShopifyDiscountCodeVariables | UpdateShopifyDiscountCodeVariables & {
            id: string;
        })[], options?: LimitToKnownKeys<Options, UpdateShopifyDiscountCodeOptions>): Promise<UpdateShopifyDiscountCodeResult<Options>[]>;
        type: "action";
        ...
        optionsType: UpdateShopifyDiscountCodeOptions;
        schemaType: Query["shopifyDiscountCode"];
        variablesType: (FullyQualifiedUpdateShopifyDiscountCodeVariables | UpdateShopifyDiscountCodeVariables & {
            id: string;
        })[];
        variables: {
            inputs: {
    ...
    delete: typeof deleteShopifyDiscountCode & {
        type: "action";
...
*/
    bulkDelete: {
        <Options extends DeleteShopifyDiscountCodeOptions>(ids: string[], options?: LimitToKnownKeys<Options, DeleteShopifyDiscountCodeOptions>): Promise<DeleteShopifyDiscountCodeResult<Options>[]>;
        type: "action";
