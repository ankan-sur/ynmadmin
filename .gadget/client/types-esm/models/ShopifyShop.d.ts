...
import { Query, Select, DeepFilterNever, ShopifyShop, ShopifyShopSort, ShopifyShopFilter, AvailableShopifyShopSelection, UpdateShopifyShopInput } from "../types.js";
 ...
 **/
export type UpdateShopifyShopResult<Options extends UpdateShopifyShopOptions> = SelectedShopifyShopOrDefault<Options> extends void ? void : GadgetRecord<SelectedShopifyShopOrDefault<Options>>;
/**
  * Executes the update action on one record specified by `id`. Runs the action and returns a Promise for the updated record.
  */
declare function updateShopifyShop<Options extends UpdateShopifyShopOptions>(id: string, variables: UpdateShopifyShopVariables, options?: LimitToKnownKeys<Options, UpdateShopifyShopOptions>): Promise<UpdateShopifyShopResult<Options>>;
declare function updateShopifyShop<Options extends UpdateShopifyShopOptions>(id: string, variables: FullyQualifiedUpdateShopifyShopVariables, options?: LimitToKnownKeys<Options, UpdateShopifyShopOptions>): Promise<UpdateShopifyShopResult<Options>>;
 ...
 **/
    ...
    update: typeof updateShopifyShop & {
        type: "action";
...
*/
    bulkUpdate: {
        <Options extends UpdateShopifyShopOptions>(inputs: (FullyQualifiedUpdateShopifyShopVariables | UpdateShopifyShopVariables & {
            id: string;
        })[], options?: LimitToKnownKeys<Options, UpdateShopifyShopOptions>): Promise<UpdateShopifyShopResult<Options>[]>;
        type: "action";
        ...
        optionsType: UpdateShopifyShopOptions;
        schemaType: Query["shopifyShop"];
        variablesType: (FullyQualifiedUpdateShopifyShopVariables | UpdateShopifyShopVariables & {
            id: string;
        })[];
        variables: {
            inputs: {
